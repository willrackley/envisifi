...
export function SixPicCollage (props) { 
    return (
        <span>
            <div className={props.className1} style={props.imgDivStyle1} onDoubleClick={props.onClick1} >
                <img id={props.id1} style={props.img1Style} src='http://www.eco-trailer.co.uk/wp-content/uploads/2016/03/placeholder-blank.jpg' alt="placeholder"/>
            ...
            <div className={props.className6} style={props.imgDivStyle6} onDoubleClick={props.onClick6} >
                <img id={props.id6} style={props.img6Style} src='http://www.eco-trailer.co.uk/wp-content/uploads/2016/03/placeholder-blank.jpg' alt="placeholder"/>
            </div>
        </span>
    )
}
